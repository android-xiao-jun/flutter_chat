...
public class OptionItemView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            switch (attr) {
                case R2.styleable.OptionItemView_start_src:
                    ...
                    break;
                case R2.styleable.OptionItemView_title:
                    titleTextView.setText(typedArray.getString(attr));
                    break;
                case R2.styleable.OptionItemView_badge_count:
                    ...
                    break;
                case R2.styleable.OptionItemView_desc:
                    ...
                    break;
                case R2.styleable.OptionItemView_end_src:
                    ...
                    break;
                case R2.styleable.OptionItemView_show_arrow_indicator:
                    boolean show = typedArray.getBoolean(attr, false);
                    arrowIndicator.setVisibility(show ? VISIBLE : GONE);
                    break;

                case R2.styleable.OptionItemView_divider_align_to_title:
